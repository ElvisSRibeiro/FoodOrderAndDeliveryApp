package com.elvis.foodorderanddeliveryapp.adapter
...
import com.elvis.foodorderanddeliveryapp.R
import com.elvis.foodorderanddeliveryapp.models.Hours
import com.elvis.foodorderanddeliveryapp.models.RestaurantModel
import java.text.SimpleDateFormat
import java.util.*

class RestaurantListAdapter(val restaurantList: List<RestaurantModel?>?, var clickListener: RestaurantListClickListener): RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder >(){
    ...
    inner class MyViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        val tvRestaurantAdress: TextView = view.findViewById(R.id.tvRestaurantAdress)
        ...
        fun bind(restaurantModel: RestaurantModel?) {
            ...
            tvRestaurantAdress.text = "Adress"+restaurantModel?.address
            tvRestaurantHours.text = "Today's Hours: " +getTodayHours(restaurantModel?.hours!!)
