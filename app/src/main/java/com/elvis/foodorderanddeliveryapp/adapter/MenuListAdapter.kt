...
import com.elvis.foodorderanddeliveryapp.models.Menus
import kotlinx.android.synthetic.main.menu_recycler_row.view.*
...
class MenuListAdapter(val menuList: List<Menus?>?, val clickListener: MenuListClickListener): RecyclerView.Adapter<MenuListAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(
       ...
       val view: View = LayoutInflater.from(parent.context).inflate(R.layout.menu_recycler_row, parent, false)
