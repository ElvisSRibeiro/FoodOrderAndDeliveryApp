...
import com.elvis.foodorderanddeliveryapp.adapter.PlaceYourOrderAdapter
...
class PlaceYourOrderActivity : AppCompatActivity() {
    ...
    private fun onPlaceOrderButtonClick(restaurantModel: RestaurantModel?) {
        if (TextUtils.isEmpty(inputName.text.toString())){
            ...
            inputAddress.error = "Enter your adress"
            return
            ...
            inputCardNumber.error = "Enter your credit card info"
            return
